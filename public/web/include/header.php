...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favourite_icon.svg">
                                ...
                                <div class="profile-thumb-small">
                                    ...
                                    <div class="profile-dropdown">
                                        <div class="profile-head">
                                            <h5 class="name"><a href="/profile.php">Madison Howard</a></h5>
                                            <a class="mail" href="mailto:contact@spravato.example.com">mailnam@mail.com</a>
                                        </div>
                                        <div class="profile-body">
                                            <ul>
                                                <li><a href="profile.php"><i class="flaticon-user"></i>Personalized Profile</a></li>
                                               <!-- <li><a href="treatment-schedule.php"><i class="flaticon-message"></i>Treatment Schedule</a></li> -->
                                                <li><a href="treatment-schedule.php"><i class="flaticon-document"></i>Treatment Schedule</a></li>
                                                <li><a href="therapist-progress-tracker.php"><i class="flaticon-document"></i>Progress Tracker</a></li>
                                              <li><a href="appointment-managment.php"><i class="flaticon-document"></i>Appointment Management</a></li>
                                              <li><a href="health-journal.php"><i class="flaticon-document"></i>Health Journal</a></li>
                                              <li><a href="telehealth-integration.php"><i class="flaticon-document"></i>Telehealth Integration</a></li>
                                              <li><a href="medication-reminders.php"><i class="flaticon-document"></i>Medication Reminders</a></li>
                                              <li><a href="patient-management.php"><i class="flaticon-document"></i>Patient Management</a></li>
                                              <li><a href="treatment-documentation.php"><i class="flaticon-document"></i>Treatment Documentation</a></li>
                                              <li><a href="session-scheduling.php"><i class="flaticon-document"></i>Session Scheduling</a></li>
                                              <li><a href="client-progress-tracker.php"><i class="flaticon-document"></i>Progress Reports</a></li>
                                              <li><a href="communication-tools.php"><i class="flaticon-document"></i>Communication Tools</a></li>
                                            </ul>
                                            <ul>
                                                <li><a href="signup.php"><i class="flaticon-unlock"></i>Sign out</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
