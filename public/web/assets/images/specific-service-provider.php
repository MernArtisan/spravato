...
<style>
    ...
    <main>
        ...
        <header class="progress-header">
            <h1>Specific Service Provider</h1>
        </header>
       <!--my-code--->
<!--my-code--->
<div class="all-provides-container">
    <div class="all-provides-header">
        <h2>Spravato Treatment Services</h2>
        <p>FDA-approved esketamine nasal spray for treatment-resistant depression</p>
    </div>

    <div class="all-provides-grid">
        <!-- Service 1 -->
        <div class="all-provides-card">
            <div class="all-provides-img-container">
                <img src="assets/images/post/post-6.jpg" alt="Initial Evaluation" class="all-provides-img">
                <button class="all-provides-view-btn" data-service="evaluation">
                    <i class="bi bi-info-circle"></i> View Details
                </button>
            </div>
            <div class="all-provides-content">
                <h3>Initial Evaluation</h3>
                <p>Comprehensive assessment to determine if Spravato is right for you</p>
            </div>
        </div>
        ...
        <div class="all-provides-card">
            <div class="all-provides-img-container">
                <img src="assets/images/post/post-6.jpg" alt="Treatment Session" class="all-provides-img">
                <button class="all-provides-view-btn" data-service="treatment">
                    <i class="bi bi-info-circle"></i> View Details
                </button>
            </div>
            <div class="all-provides-content">
                <h3>Treatment Sessions</h3>
                <p>Supervised administration in our comfortable clinic</p>
            </div>
        </div>
        ...
        <div class="all-provides-card">
            <div class="all-provides-img-container">
                <img src="assets/images/post/post-6.jpg" alt="Therapy Integration" class="all-provides-img">
                <button class="all-provides-view-btn" data-service="therapy">
                    <i class="bi bi-info-circle"></i> View Details
                </button>
            </div>
            <div class="all-provides-content">
                <h3>Therapy Integration</h3>
                <p>Combined with psychotherapy for enhanced results</p>
            </div>
        </div>
        <!-- Service 4 -->
        <div class="all-provides-card">
...
<!-- Service Modals -->
<div class="all-provides-modal" id="evaluationModal">
    <div class="all-provides-modal-content">
        <span class="all-provides-close">&times;</span>
        <img src="assets/images/post/post-6.jpg" alt="Initial Evaluation" class="all-provides-modal-img">
        <div class="all-provides-modal-body">
            <h3>Initial Evaluation</h3>
            <p>Our comprehensive evaluation includes:</p>
            <ul>
                <li>90-minute psychiatric assessment</li>
                <li>Complete medical history review</li>
                <li>Evaluation of treatment-resistant depression</li>
...
<div class="all-provides-modal" id="treatmentModal">
    <div class="all-provides-modal-content">
        <span class="all-provides-close">&times;</span>
        <img src="assets/images/post/post-6.jpg" alt="Treatment Session" class="all-provides-modal-img">
        <div class="all-provides-modal-body">
            <h3>Treatment Sessions</h3>
            <p>Our Spravato treatment protocol includes:</p>
            <ul>
                <li>Supervised administration of esketamine nasal spray</li>
                <li>2-hour monitored sessions</li>
                <li>Vital signs monitoring throughout</li>
...
<div class="all-provides-modal" id="therapyModal">
    <div class="all-provides-modal-content">
        <span class="all-provides-close">&times;</span>
        <img src="assets/images/post/post-6.jpg" alt="Therapy Integration" class="all-provides-modal-img">
        <div class="all-provides-modal-body">
            <h3>Therapy Integration</h3>
            <p>We combine Spravato with evidence-based therapies:</p>
            <ul>
                <li>Cognitive Behavioral Therapy (CBT)</li>
                <li>Mindfulness-based techniques</li>
                <li>Psychoeducation about depression</li>
                <li>Relapse prevention strategies</li>
                <li>Weekly therapy sessions included</li>
            </ul>
            <a href="#">
            <button class="all-provides-appointment-btn">
                <i class="bi bi-calendar-plus"></i> Make an Appointment
...
============================================ -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const modals = {
            evaluation: document.getElementById('evaluationModal'),
            treatment: document.getElementById('treatmentModal'),
            therapy: document.getElementById('therapyModal')
        };
      ...
      //  const appointmentBtns = document.querySelectorAll('.all-provides-appointment-btn');
